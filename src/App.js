...
export default function App() {
  ...
  return (
    <div className="App">
      <div className={getWidgetContainerClassName(isOpened)}>
        <Content isOpened={isOpened} setIsOpened={setIsOpened} />

        <button
          type="button"
          className={getWidgetLauncherClassName(isOpened)}
          onClick={() => {
        ...
        >
          <img
            ...
            className={getLauncherOpenClassName(isOpened)}
            alt=""
          />
          <img
            src="data:image/svg+xml;base64,"
            className={getLauncherCloseClassName(isOpened)}
            alt=""
          />
        </button>
      </div>
